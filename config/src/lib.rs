...
define_config!(
    ...
    (correction_pawn_weight: i32, "Correction Pawn Weight", UciOptionType::Spin { min: 0, max: 20000 }, 10500, cfg!(feature = "tuning")),
    (correction_minor_weight: i32, "Correction Minor Weight", UciOptionType::Spin { min: 0, max: 20000 }, 8500, cfg!(feature = "tuning")),
    (correction_nonpawn_weight: i32, "Correction NonPawn Weight", UciOptionType::Spin { min: 0, max: 20000 }, 11500, cfg!(feature = "tuning")),
    (correction_continuation_weight: i32, "Correction Continuation Weight", UciOptionType::Spin { min: 0, max: 20000 }, 4500, cfg!(feature = "tuning")),
    (correction_combined_divisor: i32, "Correction Combined Divisor", UciOptionType::Spin { min: 1024, max: 500000 }, 130000, cfg!(feature = "tuning")),
